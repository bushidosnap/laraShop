            ...
            <div class="checkout-table-container">
                ...
                <div class="checkout-table">
                    ...
                    <div class="checkout-table-row">
                        <div class="checkout-table-row-left">
                            <img src="{{ asset('storage/'.$item->model->image) }}" alt="{{$item->model->name}}" class="checkout-table-img">
                            <div class="checkout-item-details">
                                <div class="checkout-table-item">{{ $item->model->name }}</div>
                                <div class="checkout-table-description">{{ $item->model->details }}</div>
                                <div class="checkout-table-price">{{ setPrice($item->model->price) }}</div>
                            </div>
                ...
                <div class="checkout-totals">
                    ...
                    <div class="checkout-totals-right">
                        ...
                        @if (session()->has('coupon'))
                            -{{ setPrice($discount) }} <br>
                            <hr>
                            {{ setPrice($newSubtotal) }} <br>
                        @endif
                        {{ setPrice(Cart::tax()) }} <br>
                        <span class="checkout-totals-total">{{ setPrice(Cart::total()) }}</span>
